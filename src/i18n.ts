...
export const translations = {
  zh: {
    ...
    rules:
      "選片規則：每年取 AniList 全球人氣前 15 名（含 TV 與 ONA），同年同系列續作只計一部，並排除台灣從未代理的作品；中文採台灣官方譯名。",
    ...
    promptZako: "雜魚❤",
    copy: "複製",
    openInChatWise: "在 ChatWise 中開啟 (需要先安裝)",
    footer: "歷年人氣最高的動畫，數據來自 AniList，由",
    madeBy: "製作，",
    viewCode: "查看程式碼",
    otherProducts: "作者的其它產品: ",
    aiChatClient: ", 一個優雅的 AI 聊天客戶端",
    year: "年",
    watched: "看過",
    notWatched: "沒看過",
    none: "無",
  ...
  en: {
    ...
    website: "anime-sedai.egoist.dev",
    rules:
      "Selection: top 15 by AniList global popularity each year (TV + ONA), one entry per franchise per year, excluding titles never licensed in Taiwan; Chinese uses official Taiwan titles.",
    ...
    footer: "Most popular anime by year, data from AniList, made by ",
    madeBy: ", ",
    viewCode: "View Code",
  ...
  ja: {
    ...
    website: "anime-sedai.egoist.dev",
    rules:
      "選定基準：各年 AniList 人気上位15作（TV＋ONA）、同一シリーズの続編は1作のみ、台湾未配信作は除外。",
    ...
    footer: "各年で人気の最も高いアニメ。データソース：AniList。作成者：",
    madeBy: "。",
    viewCode: "ソースコードを見る",
